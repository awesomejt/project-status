...
class TestCreateStatusRecord:
    ...
    def test_create_status_record_success(self, client, sample_status_record_data):
        ...
        response = client.post("/api/project/status", json=sample_status_record_data, content_type="application/json")
    ...
    def test_create_status_record_missing_required_fields(self, client):
        ...
        response = client.post("/api/project/status", json={"project_name": "Test"}, content_type="application/json")
